...
const CryptoBillingPage = () => {
  const [selectedCrypto, setSelectedCrypto] = useState("");
  const [amount, setAmount] = useState("");
  const [memo, setMemo] = useState("");
  const [showConfirmation, setShowConfirmation] = useState(false);
  const [showSonicVerification, setShowSonicVerification] = useState(false);
  ...
  const cryptoWallets = {
    ...
    sonic: {
      address: "sonic1qr3aq9tatm4qt6ll3qcmv5tvk3f29lld2mk6yz",
  ...
  const addTransaction = () => {
    ...
    // Simulate verification for Sonic blockchain after 2 seconds
    if (selectedCrypto === "sonic") {
      setTimeout(() => {
        ...
        // Show Sonic verification popup
        setShowSonicVerification(true);
      }, 2000);
    }
  };
  ...
  const confirmPayment = () => {
    ...
    // Only redirect to the ResearchToolsMarketplace page for non-Sonic payments
    if (selectedCrypto !== "sonic") {
      navigate("/tools");
    }
  ...
  const closeSonicVerification = () => {
    setShowSonicVerification(false);
    navigate("/tools");
  };
  ...
  const styles = {
    ...
    sonicVerificationContent: {
      ...
      position: "relative",
      zIndex: 10,
      border: "2px solid #4f46e5", // Sonic brand color
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.mainContent}>
        ...
        {showSonicVerification && (
          <div style={styles.sonicVerificationModal}>
            <div style={styles.modalOverlay} />
            <div style={styles.sonicVerificationContent}>
              <div style={styles.sonicLogo}>
                <div style={styles.sonicIconContainer}>
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 24 24"
              ...
              <h2 style={styles.modalTitle}>Sonic Blockchain Verification</h2>
              ...
              <div style={styles.modalInfo}>
                <p>
                  Your payment of <strong>{amount} SONIC</strong> has been
                  successfully verified on the Sonic Blockchain network.
                </p>
                <p>
                  Transaction hash: <strong>{transactions[0].hash}</strong>
                </p>
                <p>
                  Confirmation time: <strong>0.8 seconds</strong>
                </p>
              </div>
              <button
                style={{ ...styles.button, ...styles.buttonEnabled }}
                onClick={closeSonicVerification}
              >
                Continue to Research Tools
              </button>
            </div>
          </div>
        )}
...
export default CryptoBillingPage;
